...
print("Danh sách con vật sao khi thêm theo index:",danh_sach_con_vat)
...
if con_vat_xoa in danh_sach_con_vat:
    ...
    print("Con vật không cfos trong danh sách.")
    #Sửa tên con vật
    ...
    if con_vat_cu in danh_sach_con_vat:
        ...
        print("Danh sách con vaqajt sau khi sửa:",danh_sach_con_vat)
    else:
        print("Con vật không có tronbg danh sách.")
        # Số lượng con vật trong danh sách
        print("Số lượng con vật trong sách:",len(danh_sach_con_vat))
        # Xó theo vị trí index
